...
# load the data
train = pd.read_csv("../data/external/glass_identification/glass_identification_train.csv")
val = pd.read_csv("../data/external/glass_identification/glass_identification_val.csv")
test = pd.read_csv("../data/external/glass_identification/glass_identification_test.csv")
