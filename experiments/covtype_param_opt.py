...
# load the data
train = pd.read_csv("../data/external/covtype/covtype_train.csv")
val = pd.read_csv("../data/external/covtype/covtype_val.csv")
test = pd.read_csv("../data/external/covtype/covtype_test.csv")
